...
export const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { slug: 'buttons',    title: 'Buttons',     blurb: 'Primary black, secondary outline, tertiary link.', status: 'live',  preview: 'buttons.html',    thumbTone: 'dark',   thumbGraphic: 'buttons' },
      { slug: 'tabs',       title: 'Tabs',        blurb: 'Pill-shaped chips with 1px active border.',   status: 'live',  preview: 'tabs.html',       thumbTone: 'white',  thumbGraphic: 'tabs' },
      { slug: 'form',       title: 'Form',        blurb: 'Inputs, textarea, select, validation states.', status: 'live',  preview: 'form.html',       thumbTone: 'subtle', thumbGraphic: 'form' },
      { slug: 'pagination', title: 'Pagination',  blurb: '32px squares with active chip and ellipses.', status: 'live',  preview: 'pagination.html', thumbTone: 'white',  thumbGraphic: 'pagination' },
